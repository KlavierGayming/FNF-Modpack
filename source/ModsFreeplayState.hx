...
class ModsFreeplayState extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('modFreeplaySonglist'));

		for (i in 0...initSonglist.length)
		{
			var data:Array<String> = initSonglist[i].split(':');
			songs.push(new SongMetadataMod(data[0], Std.parseInt(data[2]), data[1]));
		}
	...
	{
		songs.push(new SongMetadataMod(songName, weekNum, songCharacter));
	}
