								...
								case 'onslaught' :
									...
									case 'ron' | 'little-man':
										...
										case 'sunshine' :
											...
											{
												var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('mods/chara/chara-bg'));
												bg.antialiasing = true;
												bg.scrollFactor.set(0.7, 0.7);
												bg.active = false;
												add(bg);
		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					if (daSong == 'nerves')
						FlxG.switchState(new VideoState('videos/garcello_dies.webm', new PlayState()));
