...
class ModsStoryState extends MusicBeatState
{
	...
	var grpWeekText:FlxTypedGroup<ModMenuItem>;
	...
	override function create()
	{
		...
		var yellowBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFF009914);
		...
		{
			var weekThing:ModMenuItem = new ModMenuItem(0, yellowBG.y + yellowBG.height + 10, i);
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.BACK && !movedBack && !selectedWeek)
		{
			...
			movedBack = true;
			FlxG.switchState(new ModSelectState());
		}
