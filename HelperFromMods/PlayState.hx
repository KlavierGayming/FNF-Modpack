...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'line art':
				dialogue = CoolUtil.coolTextFile(Paths.txt('line art/Dialog'));
			case 'sketched out':
				dialogue = CoolUtil.coolTextFile(Paths.txt('sketched out/Dialog'));
			case 'rip and tear':
				dialogue = CoolUtil.coolTextFile(Paths.txt('rip and tear/Dialog'));
			case 'senpai':
		...
		if (FlxG.save.data.songPosition) // I dont wanna talk about this code :(
			{
				...
				songPosBar.createFilledBar(FlxColor.GRAY, 0xFF525252);
				add(songPosBar);
		...
		healthBar.createFilledBar(0xFF525252, 0xFFC9C9C9);
		// healthBar
		add(healthBar);
